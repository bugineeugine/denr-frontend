  ...
  return (
    <>
      ...
      <div className="font-body" style={{ background: "var(--forest-950)", color: "#fff" }}>
        ...
        >
          <div className="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[9px] uppercase tracking-[0.18em] text-emerald-400/60 leading-tight">
                  Permit System
                </p>
              </div>
            </div>
          ...
          {menuOpen && (
            <div className="md:hidden px-6 pb-5 flex flex-col gap-4 border-t border-white/5 pt-4">
              ...
              <Link
                href="/login"
                className="btn-primary rounded-xl px-5 py-3 text-[13px] font-semibold text-white text-center mt-2"
              >
        ...
        <section
          id="home"
          className="hero-mesh grid-texture relative min-h-screen flex flex-col items-center justify-center pt-20 overflow-hidden"
        >
          ...
          <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
            {/* Badge */}
            <div
              className="anim-badge inline-flex items-center gap-2.5 rounded-full px-4 py-2 mb-8"
              style={{
            ...
            {/* Headline */}
            <h1
              className="anim-1 font-display text-5xl md:text-7xl lg:text-8xl font-800 leading-[0.92] mb-6"
            ...
            {/* Sub */}
            <p
              className="anim-2 text-lg md:text-xl text-white/50 max-w-xl mx-auto leading-relaxed mb-3"
            ...
            <p className="anim-2 text-sm text-white/30 max-w-lg mx-auto leading-relaxed mb-10">
              Streamlining environmental compliance through advanced digital verification, comprehensive analytics, and
              innovative permit management technology.
            </p>
            ...
            <div className="anim-3 flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a href="#services" className="btn-secondary rounded-2xl px-8 py-4 text-[15px] font-semibold">
                Explore Features
              </a>
            </div>
          </div>
          ...
          <div className="anim-4 relative z-10 mx-auto max-w-3xl px-6 mt-20 mb-16 grid grid-cols-3 gap-4 w-full">
            {STATS.map((s) => (
              <div key={s.label} className="stat-card rounded-2xl px-4 py-5 text-center">
                <p className="font-display text-3xl md:text-4xl font-700 mb-1" style={{ color: "#fbbf24" }}>
                  {s.value}
                </p>
        ...
        <section id="services" style={{ background: "var(--forest-950)" }} className="py-28 px-6">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="flex items-center gap-4 mb-5">
              ...
              <span className="text-[10px] uppercase tracking-[0.3em] font-semibold" style={{ color: "#fbbf24" }}>
                System Features
              </span>
              <div className="ornament-line flex-1" />
            </div>
            ...
            <div className="text-center mb-16">
              <h2
                className="font-display text-4xl md:text-5xl font-700 text-white mb-4"
                style={{ letterSpacing: "-0.02em" }}
              >
                Everything you need for
                <br />
                <em className="not-italic" style={{ color: "#86efac" }}>
                  permit compliance
                </em>
              </h2>
              ...
              {FEATURES.map((f) => (
                <div key={f.number} className="feature-card rounded-2xl p-8 flex gap-6">
                  <div className="shrink-0">
                    <span
                      className="feature-number block font-display text-4xl font-700 leading-none transition-colors duration-300"
          ...
          <div className="mx-auto max-w-6xl">
            <div className="flex items-center gap-4 mb-5">
              <div
                ...
                style={{ background: "linear-gradient(90deg, transparent, rgba(20,83,45,0.3), transparent)" }}
              />
              <span className="text-[10px] uppercase tracking-[0.3em] font-semibold" style={{ color: "#166534" }}>
                About the System
              </span>
              <div
                className="h-px flex-1"
            ...
            <div className="text-center mb-16">
              <h2
                ...
                style={{ color: "#0f2d0c", letterSpacing: "-0.02em" }}
              >
                Built for DENR-CENRO
                <br />
                <em className="not-italic" style={{ color: "#166534" }}>
                  operations
                </em>
              </h2>
              <p className="text-slate-500 max-w-2xl mx-auto text-base leading-relaxed" style={{ fontWeight: 300 }}>
                ...
                compliance in the transport sector — combining cutting-edge technology with environmental stewardship to
                ensure sustainable transport practices across local communities.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              <div className="about-card rounded-2xl p-8">
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <h3 className="font-display text-xl font-700" style={{ color: "#0f2d0c" }}>
                    Our Mission
                  </h3>
                </div>
              ...
              <div className="about-card rounded-2xl p-8">
                ...
                <p className="text-slate-500 leading-relaxed text-sm" style={{ fontWeight: 300 }}>
                  ...
                  sustainable development and environmental conservation for generations to come.
                </p>
              </div>
            </div>
            ...
            <div
              ...
              style={{
                background: "linear-gradient(135deg, #0f2d0c, #14532d)",
                border: "1px solid rgba(74,222,128,0.15)",
              }}
            >
              <div>
        ...
        <footer className="footer-bg py-16 px-6">
          <div className="mx-auto max-w-6xl">
            <div className="grid md:grid-cols-4 gap-10 mb-12">
              ...
              {/* Services */}
              <div>
                <p className="text-[10px] uppercase tracking-[0.2em] font-semibold mb-4" style={{ color: "#fbbf24" }}>
                  Services
                </p>
                <ul className="space-y-2.5">
                  {["Permit Verification", "Data Analytics", "Compliance Monitoring", "Environmental Assessment"].map(
                    (s) => (
                      <li key={s}>
                        <a
                          href="#"
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {[
                    { icon: "✉", text: "cenrostacruz@denr.gov.ph" },
                    { icon: "☏", text: "(049) 536 8903/ 409 557-3231" },
                    ...
                    <li key={c.text} className="flex items-start gap-2.5">
                      ...
                      <span className="text-white/30 text-xs leading-relaxed" style={{ fontWeight: 300 }}>
                        {c.text}
                      </span>
                    </li>
                  ))}
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-3">
              <p className="text-white/20 text-[11px]" style={{ fontWeight: 300 }}>
                © {new Date().getFullYear()} Department of Environment and Natural Resources — CENRO. All rights
                reserved.
              </p>
              <div className="flex items-center gap-2">
                <span className="h-1 w-1 rounded-full bg-emerald-400/40" />
                <span className="text-white/20 text-[11px]" style={{ fontWeight: 300 }}>
